...
const devReleaseWorkflowFile = `# ~~ Generated by projen. To modify, edit .projenrc.js and run "npx projen".
...
if (!fs.existsSync(devReleaseWorkflowPath) || fs.readFileSync(devReleaseWorkflowPath, "utf8") !== devReleaseWorkflowFile) {
  if (fs.existsSync(devReleaseWorkflowPath)) {
    fs.chmodSync(devReleaseWorkflowPath, 0o644);
  }
  fs.writeFileSync(devReleaseWorkflowPath, devReleaseWorkflowFile);
  fs.chmodSync(devReleaseWorkflowPath, 0o444);
}
